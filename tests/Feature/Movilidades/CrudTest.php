...
class CrudTest extends TestCase
{
     ...
     * A basic test example.
     */
    public function testEditarMovilidadInactivaDeUnColaboradorConElMismoValorSegundoTest()
    {
        $colaborador = factory(Colaborador::class)->create();
        $cargo = factory(Cargo::class)->create();
        $cargoNuevo = factory(Cargo::class)->create();
        ...
        $primeraMovilidad = factory(Movilidad::class)->create([
            ...
            'tipo_movilidad_id' => $tipoMovilidadNuevo->id,
            'estado' => 0,
            'fecha_inicio' => Carbon::createFromDate('2020', '03', '12')->format('Y-m-d'),
            'fecha_termino' => Carbon::createFromDate('2020', '12', '12')->format('Y-m-d'),
        ]);

        $segundaMovilidad = factory(Movilidad::class)->create([
            'fecha_inicio' => Carbon::createFromDate('2020', '12', '13')->format('Y-m-d'),
            'colaborador_id' => $colaborador->id,
            'cargo_id' => $cargo->id,
            'tipo_movilidad_id' => $tipoMovilidadDesarrollo->id,
            'estado' => 1,
        ...
        // dd($parameters);
        $url = '/api/movilidades/'.$primeraMovilidad->id;
